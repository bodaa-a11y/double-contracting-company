...
export const PROJECTS: ProjectItem[] = [
  ...
  {
    id: 'proj-luxury-palace',
    title: 'مشروع القصر والفيلا السكني الخاص',
    category: 'villas',
    categoryLabel: 'قصور وتصاميم ملكية',
    location: '',
    area: '3,500 م²',
    completionYear: '2024',
    client: 'قطاع التطوير السكني الفاخر',
    value: '22,000,000 ريال',
    image: '/projects/noura_1.jpg',
    gallery: [
    ...
    description: 'تصميم وتنفيذ قصر ملكي خاص بتشطيبات رخامية مميزة وإضاءات جدارية وواجهات معمارية فاخرة.',
    keyFeatures: ['تشطيب رخامي فاخر', 'إضاءات معمارية مخفية', 'حديقة منزلية ومسبح ذكي']
  },
  {
    id: 'proj-hanan-villas',
    title: 'مشروع مجمع الفلل المودرن الفاخرة',
    category: 'villas',
    ...
    description: 'فلل سكنية فاخرة بتصميم معماري مودرن فريد يجمع بين الخصوصية التامة والجمال العصري والمسابح الذكية.',
