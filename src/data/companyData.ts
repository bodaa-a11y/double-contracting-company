...
export const PROJECTS: ProjectItem[] = [
  {
    id: 'proj-villas',
    title: 'مشروع مجمع فلل ندرة السكني الفاخر',
    category: 'villas',
    ...
    description: 'مشروع مجمع فلل ندرة السكني الفاخر يجسد أعلى درجات الفخامة والرفاهية والواجهات المعمارية المودرن مع المساحات الخضراء والإنارة الليلية.',
    keyFeatures: ['تصميم معماري ملكي مخصص', 'تشطيبات فاخرة عالية الجودة', 'حدائق خاصة ومساحات خضراء', 'معرض شامل لصور فلل ندرة']
  },
  {
    id: 'proj-finishing',
