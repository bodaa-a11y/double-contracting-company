...
export const COMPANY_INFO = {
  name: 'شركة دبل للمقاولات والتجارة العامة',
  tagline: 'نبني المستقبل بجودة، احترافية، وثقة',
  shortDesc: 'صرح رائد في مجالات المقاولات العامة والتطوير العقاري والتجارة، يمتلك عقوداً من الخبرة في تنفيذ المشاريع الضخمة والبنى التحتية الشاملة بأعلى معايير الجودة العالمية.',
...
export const TESTIMONIALS: TestimonialItem[] = [
  {
    ...
    comment: 'تعتبر شركة دبل للمقاولات النموذج الأمثل في تنفيذ المشاريع المعقدة. تم تسليم مشروع برجنا السكني قبل موعده المحدد بـ 3 أشهر مع مراعاة كافة أدق التفاصيل الهندسية.',
    rating: 5,
  ...
  },
  {
    ...
    comment: 'الاحترافية العالية والدقة الشديدة في التشطيبات هي أهم ما يميز طاقم شركة دبل. تعاملنا معهم في عدة مشاريع تجارية وسنستمر دائماً كشركاء نجاح.',
    rating: 5,
